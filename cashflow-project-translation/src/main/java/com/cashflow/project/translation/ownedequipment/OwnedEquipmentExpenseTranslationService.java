package com.cashflow.project.translation.ownedequipment;
...
public interface OwnedEquipmentExpenseTranslationService {
    ...
    @Nonnull
    @Default("Owned Equipment Charge Schedule Detail")
    @Info("Translated Header Label for Owned Equipment Charge Schedule Detail")
    String getOwnedEquipmentDetailHeader();
    ...
    @Nonnull
    @Default("Owned Equipment Approved Successfully")
    @Info("Translated message for Owned Equipment Approved Successfully")
    String getOwnedEquipmentApprovedSuccessMessage();
    ...
    @Default("Select Category")
    @Info("Translated Label for Select Category")
    String getSelectCategoryLabel();

    @Nonnull
    @Default("Select Sub-Category")
    @Info("Translated Label for Select Sub-Category")
    String getSelectSubCategoryLabel();

    @Nonnull
    @Default("Select Equipment Name")
    @Info("Translated Label for Select Equipment Name")
    String getSelectEquipmentNameLabel();

    @Nonnull
    @Default("Select Equipment ID")
    @Info("Translated Label for Select Equipment ID")
    String getSelectEquipmentIdLabel();
