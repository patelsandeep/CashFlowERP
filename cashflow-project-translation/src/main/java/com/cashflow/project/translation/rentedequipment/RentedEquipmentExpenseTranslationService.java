package com.cashflow.project.translation.rentedequipment;
...
public interface RentedEquipmentExpenseTranslationService {
    ...
    @Nonnull
    @Default("Rented Equipment Approved Successfully")
    @Info("Translated Message for Rented Equipment Approved Successfully")
    String getRentedEquipApprovedSuccessfully();
    ...
    @Nonnull
    @Default("Select Suppier")
    @Info("Translated Label for Select Suppier")
    String getSelectSuppierLabel();
    ...
    @Nonnull
    @Default("Billable Quantity cannot be greater than invoice Quantity")
    @Info("Translated Label for Billable Quantity cannot be greater than invoice Quantity")
    String getBillableQtyValidationMessage();

    @Nonnull
    @Default("Non-Billable Quantity cannot be greater than invoice Quantity")
    @Info("Translated Label for Non-Billable Quantity cannot be greater than invoice Quantity")
    String getNonBillableQtyValidationMessage();
