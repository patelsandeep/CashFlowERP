...
public class ProjectEndDateQueryBuilder extends ProjectDateQueryBuilder {
    ...
    public Optional<Predicate> buildPredicate(ProjectContext context,
        ...
        final Calendar endFromDate = context.getEndingFromDate();
        final Calendar endToDate = context.getEndingToDate();
        return doBuildPredicate(context, criteriaBuilder, queryRoot, Project_.endDate, endFromDate, endToDate);
    }
