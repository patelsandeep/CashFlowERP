...
public class ProjectCreatedDateQueryBuilder extends ProjectDateQueryBuilder {
    ...
    public Optional<Predicate> buildPredicate(ProjectContext context,
        ...
        final Calendar createdFromDate = context.getCreatedFromDate();
        final Calendar createdToDate = context.getCreatedToDate();
        return doBuildPredicate(context, criteriaBuilder, queryRoot, Project_.createdDate, createdFromDate,
                                createdToDate);
    }
