package com.cashflow.project.config.cacheing;

import com.cashflow.access.authorization.service.config.RedisConnectionConfigurationService;
 ...
 *
 * 
 * @since Dec 12, 2016, 10:19:07 AM
 */
@ConfigRoot
@ConfigProject("AZPM")
@Config(propertyFile = "config-service.properties")
@AppContext(applicationModes = {LOCAL, DEVELOPMENT, TEST, LIVE})
public interface ProjectRedisConnectionConfigurationService extends RedisConnectionConfigurationService {
}
