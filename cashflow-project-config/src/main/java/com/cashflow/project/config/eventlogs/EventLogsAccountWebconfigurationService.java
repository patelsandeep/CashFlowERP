package com.cashflow.project.config.eventlogs;
...
@ProjectEndpoint(client = "AZPM", endpoint = "AZEL")
@AppContext(applicationModes = {LOCAL, DEVELOPMENT, TEST, LIVE})
public interface EventLogsAccountWebconfigurationService extends WebserviceConfiguration {
}
