package com.cashflow.project.config.useraccount;
...
@ProjectEndpoint(client = "AZPM", endpoint = "AZUA")
@AppContext(applicationModes = {LOCAL, DEVELOPMENT, TEST, LIVE})
public interface ProjectUserAccountWebconfigurationService extends WebserviceConfiguration {
}
