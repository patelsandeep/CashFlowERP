package com.cashflow.project.config.receivable;

import com.cashflow.project.config.useraccount.*;
...
@ProjectEndpoint(client = "AZPM", endpoint = "AZRA")
@AppContext(applicationModes = {LOCAL, DEVELOPMENT, TEST, LIVE})
public interface ProjectReceivableWebconfigurationService extends WebserviceConfiguration {
}
