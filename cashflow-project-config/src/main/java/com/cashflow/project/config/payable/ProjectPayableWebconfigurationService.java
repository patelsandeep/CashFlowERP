package com.cashflow.project.config.payable;
...
@ProjectEndpoint(client = "AZPM", endpoint = "AZAP")
@AppContext(applicationModes = {LOCAL, DEVELOPMENT, TEST, LIVE})
public interface ProjectPayableWebconfigurationService extends WebserviceConfiguration {
}
