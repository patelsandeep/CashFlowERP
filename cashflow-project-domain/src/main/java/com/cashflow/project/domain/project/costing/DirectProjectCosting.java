...
@NamedQueries({
    @NamedQuery(name = "DirectProjectCosting.findDirectProjectCostings",
                query = "SELECT dpc FROM DirectProjectCosting dpc WHERE dpc.projectLevel.uuid IN :projectLevelUUIDs")
})
public class DirectProjectCosting extends ProjectCosting {
