...
@NamedQueries({
    @NamedQuery(name = "DirectProjectRevenue.findDirectProjectRevenues",
                query = "SELECT dpr FROM DirectProjectRevenue dpr WHERE dpr.projectLevel.uuid IN :projectLevelUUIDs")
})
public class DirectProjectRevenue extends ProjectRevenue {
